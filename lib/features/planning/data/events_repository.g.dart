...
@ProviderFor(spotSuggestionsFor)
final spotSuggestionsForProvider = SpotSuggestionsForFamily._();

final class SpotSuggestionsForProvider
    extends
        $FunctionalProvider<
          AsyncValue<List<SpotSuggestion>>,
          List<SpotSuggestion>,
          FutureOr<List<SpotSuggestion>>
        >
    with
        $FutureModifier<List<SpotSuggestion>>,
        $FutureProvider<List<SpotSuggestion>> {
  SpotSuggestionsForProvider._({
    required SpotSuggestionsForFamily super.from,
    required String super.argument,
  }) : super(
         retry: null,
         name: r'spotSuggestionsForProvider',
         isAutoDispose: true,
         dependencies: null,
         $allTransitiveDependencies: null,
       );
  ...
  @override
  String debugGetCreateSourceHash() => _$spotSuggestionsForHash();

  @override
  String toString() {
    return r'spotSuggestionsForProvider'
        ''
        '($argument)';
  }
  ...
  @$internal
  @override
  $FutureProviderElement<List<SpotSuggestion>> $createElement(
    $ProviderPointer pointer,
  ) => $FutureProviderElement(pointer);

  @override
  FutureOr<List<SpotSuggestion>> create(Ref ref) {
    final argument = this.argument as String;
    return spotSuggestionsFor(ref, argument);
  }

  @override
  bool operator ==(Object other) {
    return other is SpotSuggestionsForProvider && other.argument == argument;
  }
...
String _$spotSuggestionsForHash() =>
    r'70cecf10c3c9f85e27efd37232e915d4394a227b';

final class SpotSuggestionsForFamily extends $Family
    with $FunctionalFamilyOverride<FutureOr<List<SpotSuggestion>>, String> {
  SpotSuggestionsForFamily._()
    : super(
        retry: null,
        name: r'spotSuggestionsForProvider',
        dependencies: null,
  ...
  SpotSuggestionsForProvider call(String associationId) =>
      SpotSuggestionsForProvider._(argument: associationId, from: this);

  @override
  String toString() => r'spotSuggestionsForProvider';
}
