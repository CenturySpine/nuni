...
int get hashCode {
  final _this = this as Hole;
  return Object.hash(runtimeType,_this.id,_this.name,_this.description,_this.par,_this.distanceM,_this.startLat,_this.startLng,_this.endLat,_this.endLng,const DeepCollectionEquality().hash(_this.path),_this.photoStartPath,_this.photoEndPath,_this.ownerId,_this.clonedFrom,_this.distance);
}

@override
String toString() {
  final _this = this as Hole;
  return 'Hole(id: ${_this.id}, name: ${_this.name}, description: ${_this.description}, par: ${_this.par}, distanceM: ${_this.distanceM}, startLat: ${_this.startLat}, startLng: ${_this.startLng}, endLat: ${_this.endLat}, endLng: ${_this.endLng}, path: ${_this.path}, photoStartPath: ${_this.photoStartPath}, photoEndPath: ${_this.photoEndPath}, ownerId: ${_this.ownerId}, clonedFrom: ${_this.clonedFrom}, distance: ${_this.distance})';
}
...
/// Create a copy of Hole
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? description = freezed,Object? par = null,Object? distanceM = freezed,Object? startLat = freezed,Object? startLng = freezed,Object? endLat = freezed,Object? endLng = freezed,Object? path = freezed,Object? photoStartPath = freezed,Object? photoEndPath = freezed,Object? ownerId = null,Object? clonedFrom = freezed,Object? distance = freezed,}) {
  return _then(Hole(
...
as String,clonedFrom: freezed == clonedFrom ? _self.clonedFrom : clonedFrom // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String? description,  int par, @JsonKey(name: 'distance_m')  int? distanceM, @JsonKey(name: 'start_lat')  double? startLat, @JsonKey(name: 'start_lng')  double? startLng, @JsonKey(name: 'end_lat')  double? endLat, @JsonKey(name: 'end_lng')  double? endLng,  List<HolePathPoint>? path, @JsonKey(name: 'photo_start_path')  String? photoStartPath, @JsonKey(name: 'photo_end_path')  String? photoEndPath, @JsonKey(name: 'owner_id')  String ownerId, @JsonKey(name: 'cloned_from')  String? clonedFrom,  double? distance)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Hole() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.par,_that.distanceM,_that.startLat,_that.startLng,_that.endLat,_that.endLng,_that.path,_that.photoStartPath,_that.photoEndPath,_that.ownerId,_that.clonedFrom,_that.distance);case _:
  return orElse();
...
@override@JsonKey(name: 'cloned_from') final  String? clonedFrom;
