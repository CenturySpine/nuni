...
int get hashCode {
  final _this = this as Hole;
  return Object.hash(runtimeType,_this.id,_this.name,_this.description,_this.par,_this.distanceM,_this.startLat,_this.startLng,_this.endLat,_this.endLng,_this.photoStartPath,_this.photoEndPath,_this.visibility,_this.ownerId,_this.distance);
}

@override
String toString() {
  final _this = this as Hole;
  return 'Hole(id: ${_this.id}, name: ${_this.name}, description: ${_this.description}, par: ${_this.par}, distanceM: ${_this.distanceM}, startLat: ${_this.startLat}, startLng: ${_this.startLng}, endLat: ${_this.endLat}, endLng: ${_this.endLng}, photoStartPath: ${_this.photoStartPath}, photoEndPath: ${_this.photoEndPath}, visibility: ${_this.visibility}, ownerId: ${_this.ownerId}, distance: ${_this.distance})';
}
...
as double?,photoStartPath: freezed == photoStartPath ? _self.photoStartPath : photoStartPath // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _Hole() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.par,_that.distanceM,_that.startLat,_that.startLng,_that.endLat,_that.endLng,_that.photoStartPath,_that.photoEndPath,_that.visibility,_that.ownerId,_that.distance);case _:
  return orElse();
...
class _Hole implements Hole {
  const _Hole({required this.id, required this.name, this.description, required this.par, @JsonKey(name: 'distance_m') this.distanceM, @JsonKey(name: 'start_lat') required this.startLat, @JsonKey(name: 'start_lng') required this.startLng, @JsonKey(name: 'end_lat') this.endLat, @JsonKey(name: 'end_lng') this.endLng, @JsonKey(name: 'photo_start_path') this.photoStartPath, @JsonKey(name: 'photo_end_path') this.photoEndPath, required this.visibility, @JsonKey(name: 'owner_id') required this.ownerId, this.distance});
...
@override
int get hashCode {
    return Object.hash(runtimeType,id,name,description,par,distanceM,startLat,startLng,endLat,endLng,photoStartPath,photoEndPath,visibility,ownerId,distance);
}

@override
String toString() {
    return 'Hole(id: $id, name: $name, description: $description, par: $par, distanceM: $distanceM, startLat: $startLat, startLng: $startLng, endLat: $endLat, endLng: $endLng, photoStartPath: $photoStartPath, photoEndPath: $photoEndPath, visibility: $visibility, ownerId: $ownerId, distance: $distance)';
}
