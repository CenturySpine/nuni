...
as bool,championshipZoneId: freezed == championshipZoneId ? _self.championshipZoneId : championshipZoneId // ignore: cast_nullable_to_non_nullable
as String?,championshipSeason: freezed == championshipSeason ? _self.championshipSeason : championshipSeason // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _Session() when $default != null:
return $default(_that.id,_that.code,_that.ownerId,_that.status,_that.kind,_that.scoringMode,_that.rankingDirection,_that.city,_that.zone,_that.locationLat,_that.locationLng,_that.weather,_that.comment,_that.coverPhotoId,_that.coverPhotoPath,_that.isChampionship,_that.championshipZoneId,_that.championshipSeason,_that.createdAt,_that.startedAt,_that.endedAt);case _:
  return orElse();
...
@override@JsonKey(name: 'championship_zone_id') final  String? championshipZoneId;
