...
void main() {
  test('shrinkPhoto shrinks a wide image down to the max width', () async {
    ...
    final resized = await shrinkPhoto(original, maxWidth: 1600, quality: 80);
  ...
  test('shrinkPhoto does not upscale an already-small image', () async {
