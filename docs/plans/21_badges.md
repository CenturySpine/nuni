...
Fiche synthétique (2026-09-24), demandée par le PO pour lundi 2026-09-28. Plan détaillé à
rédiger après le tri du catalogue ci-dessous par le PO (Q96) et Q111 ; Q97 et Q98 tranchées le
2026-09-24. Dépend du socle de calcul des plans 19 et 20 : à implémenter juste après eux.
...
## Catalogue exhaustif à trier (Q96)

Réponse PO à Q96 (2026-09-24) : principe accepté, liste exhaustive à trier. Chaque badge
ci-dessous est calculable avec les données déjà en base, sans nouvelle saisie. Le PO coche
« Garder » (☑) ou laisse ☐, et peut annoter chaque badge dans la colonne « Commentaire » ;
les noms sont provisoires et seront traduits EN/FR dans les ARB.
...
J1 à J3 dépendent d'un état qui peut changer (un record battu) : voir Q111.
...
Total : 78 badges. Suggestion pour la première version : une trentaine au plus, répartis sur
toutes les familles, pour que chaque joueur en obtienne dès l'import de l'historique sans que la
liste des badges à obtenir paraisse interminable.
...
- Badges d'état (famille J) calculés en rejouant l'historique dans l'ordre chronologique, pour
  savoir si le joueur a détenu le record à un moment donné (Q111).
...
Q96 (catalogue, tri du PO), Q111 (badge d'état perdu ou gardé), Q97 (rétroactivité), Q98 (visibilité par les autres joueurs : tranchée
