...
| 27 ✅ | Associations : administrateurs locaux et partenaires (demande PO du 2026-09-25 ; Q170–Q177 tranchées ; implémenté, base reconstruite, essayé et validé par le PO ; clôturé le 2026-09-25) | [27_associations_admins_partenaires.md](27_associations_admins_partenaires.md) | Administrateurs nommés parmi les membres par le responsable local ou un super_admin, avec les droits du responsable sauf la modification des informations de l'association ; partenaires (libellé + lien) sur la page de l'association |
| 28 ✅ | Associations : référentiel de spots (demande PO du 2026-09-25 ; Q178–Q186 tranchées ; implémenté, base reconstruite, essayé et validé par le PO ; clôturé le 2026-09-25) | [28_spots_association.md](28_spots_association.md) | Spots (libellé, description, point et adresse synchronisés) gérés par le responsable et les administrateurs locaux ; choisis ou libres pour un événement, obligatoires pour une session avec création rapide « + » |
| 29 | Natures de session (demande PO du 2026-09-25 ; plan validé par le PO le 2026-09-25, non implémenté ; Q187–Q200 tranchées) | [29_natures_de_session.md](29_natures_de_session.md) | Pastilles cumulables Parcours, Training, Simulateur, Vie de l'asso ; sessions sans scores (présents, compte rendu, photos, export) ; Training et Simulateur hors stats ; badges « Vie du club » |
| 30 | Photos : miniatures et allègement (suite du plantage iPhone de la liste des trous, 2026-09-26 ; plan validé par le PO le 2026-09-26 ; code poussé le 2026-09-26, essai navigateur et script de reprise faits le 2026-09-26, essai iPhone à faire ; Q201–Q203 tranchées) | [30_miniatures_photos.md](30_miniatures_photos.md) | Miniature de 256 px créée à l'envoi et lue par les listes ; script de reprise des photos existantes, photos importées réduites à 1600 px ; photos de la fiche trou agrandissables |
