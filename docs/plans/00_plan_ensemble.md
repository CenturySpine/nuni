...
| 2 | Bootstrap du projet Flutter web + dépôt + CI | [02_bootstrap_projet_flutter_ci.md](02_bootstrap_projet_flutter_ci.md) | Squelette Flutter web committé sur `main`, `AGENTS.md`, CI GitHub Actions minimale (analyze + test + build web, un seul workflow, push direct sur `main` sans PR obligatoire) verte, premiers commits techniques permettant de créer le projet Vercel |
