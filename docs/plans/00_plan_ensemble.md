...
| 13 | Migration des données LsgScores (critique). Étape 1 (trous) livrée et testée par le PO le 2026-09-23 : 17 trous importés, repositionnement manuel en cours ; étape 2 (sessions) à détailler | [13_migration_donnees_lsgscores.md](13_migration_donnees_lsgscores.md) | Sessions, équipes, joueurs, trous et coups de l'ancienne base importés dans NUNI, vérifiés et consultables dans l'historique |
